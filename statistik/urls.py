...
urlpatterns = [
    ...
    url(r'^ratings/(?P<game>(IIDX|DDR))$', views.ratings_view, name='ratings'),
    ...
    url(r'^elo/(?P<game>(IIDX|DDR))$', views.elo_view, name='elo'),
    url(r'^login$', views.login_view, name='login'),
    url(r'^logout$', views.logout_view, name='logout'),
    url(r'^register$', views.register_view, name='register'),
    url(r'^search$', views.search_view, name='search'),
    url(r'^search/(?P<game>(IIDX|DDR))$', views.search_view, name='search'),
]
